              ...
              return (
                <button
                  ...
                  className={gameButtonClass({
                    ...
                    size: 'md',
                    disabled: isDisabled,
                    className: `w-full ${singleLetterChoices ? 'h-16 justify-center text-center' : 'text-left justify-start'} ${isResolvingAnswer && !isSelected ? 'opacity-80' : ''}`,
                  })}
                  disabled={isDisabled}
                  onClick={() => {
                ...
                >
                  {option.imageId ? (
                    <span className="flex w-full flex-col items-center gap-2">
                      ...
                      />
                      <span className="text-xs font-semibold uppercase tracking-[0.08em] text-slate-200/85">
                        {option.text}
                      </span>
                    </span>
                  ) : singleLetterChoices ? (
